...
class Account_Class extends Pdo_Class{
	...
	{
		$tmpRet = self::FunDataFetch(array("table"=>"dybs_hr_admin",
				"account"=>$sParam['user_name'],"password"=>md5($sParam['user_password'])));
